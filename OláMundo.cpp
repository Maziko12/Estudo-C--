...
int main()
{
    std::cout << "Aobaaa, tudo bem?" << std::endl;
    std::cout << "Salveeeee" << std::endl;
    std::cout << "Opa, salve??\n";
    ...
    // E isso, porque eu não sei usar a função de f'string do python, em c++: (f'Você tirou nota {nota}! Parabéns.').

    std::cout << "Olá! Meu nome é " << nome << ", eu tenho " << idade << ". Eu gosto de " << hobbie << " o jogo " << jogo << ", minhas profissões atualmente são: " << profissões;
